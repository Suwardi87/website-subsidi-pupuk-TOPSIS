...
<div id="main">
    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                ...
                <p class="mb-0">Create hasil-produksi - Subsidi Pupuk Dinas Pertanian </p>
            </div>
            <div>
    ...
    <form action="#" id="formHasilProduksi" class="card">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="hasil_produksi" id="hasil_produksi"
                            ...
                            <option value="">-- select Hasil Produksi --</option>
                            <option value="3000 - 4500 kg">3000 - 4500 kg</option>
                            <option value="4501 - 6000 kg">4501 - 6000 kg</option>
                            <option value="6001 - 7500 kg">6001 - 7500 kg</option>
                            <option value="7501 - 9000 kg">7501 - 9000 kg</option>
                            <option value="9001 - 10500 kg">9001 - 10500 kg</option>
                        </select>
