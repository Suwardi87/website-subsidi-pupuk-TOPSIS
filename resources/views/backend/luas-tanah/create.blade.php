...
@section('title', 'Create Luas Lahan')
        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    ...
                    <p class="mb-0">Create Luas Lahan - Subsidi Pupuk Dinas Pertanian </p>
                </div>
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="luas_lahan" id="luas_lahan"
                                    class="form-select @error('luas_lahan') is-invalid @enderror"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="bobot" id="bobot"
                                    class="form-select @error('bobot') is-invalid @enderror" aria-readonly="readonly">
